...
(deftest items-inside-rect
  (let [id1 (create-item! (g/build-rect (g/build-point 2 2) (g/build-point 3 4)))
        id2 (create-item! (g/build-rect (g/build-point 2 3) (g/build-point 3 5)))
        id3 (create-item! (g/build-rect (g/build-point 3 5) (g/build-point 4 6)))]
    (is (= (vec (keys (p/items-inside-rect (g/build-rect (g/build-point 1 1) (g/build-point 5 5))))) [id1 id2]))))

(deftest items-at-point
  (let [id1 (create-item! (g/build-rect (g/build-point 2 2) (g/build-point 3 4)))
        id2 (create-item! (g/build-rect (g/build-point 2 2) (g/build-point 3 5)))
        id3 (create-item! (g/build-rect (g/build-point 3 5) (g/build-point 4 6)))]
    (is (= (vec (keys (p/items-at-point (g/build-point 2 2)))) [id1 id2]))))

(deftest items-at-point-with-text
  (let [id1 (create-item! (g/build-rect (g/build-point 2 1) (g/build-point 14 7)))]
